...
static int find_extensionsGLES2(void) {
	...
	GLAD_GL_ANGLE_shader_pixel_local_storage = has_ext("GL_ANGLE_shader_pixel_local_storage");
	GLAD_GL_ANGLE_shader_pixel_local_storage_coherent = has_ext("GL_ANGLE_shader_pixel_local_storage_coherent");
	free_exts();
	return 1;
}
